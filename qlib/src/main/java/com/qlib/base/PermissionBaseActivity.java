...
import com.qlib.components.TipDialog;
import com.qlib.qutils.PermissionUtil;
...
public class PermissionBaseActivity extends AppCompatActivity {
    ...
    private void showTipDialog(String permission, final OnPermissionResultListener onPermissionResultListener) {
        if (tipDialog == null) {
            tipDialog = new TipDialog(this, PermissionUtil.getTip(permission));
        }
        // 确定按钮
        tipDialog.btn_confirm.setOnClickListener(new View.OnClickListener() {
            @Override
